...
export const GET_ACTIONS = (game_id: string, entity_id: string) =>
...
export const GET_THE_MESSAGE = (game_id: string, memory_cell: string) =>
    `${REACT_APP_BACKEND_URL}/${game_id}/message/${memory_cell.toString()}`
export const GET_ENTITY_INFO = (game_id: string, entity_id: string) =>
