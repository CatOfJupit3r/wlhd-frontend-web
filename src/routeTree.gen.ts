...
const AuthonlyLobbyRoomsLobbyIdIndexRoute = AuthonlyLobbyRoomsLobbyIdIndexImport.update({
    id: '/lobby-rooms/$lobbyId/',
    path: '/lobby-rooms/$lobbyId/',
    getParentRoute: () => AuthonlyRoute,
} as any);

const AuthonlyLobbyRoomsLobbyIdViewCharacterRoute = AuthonlyLobbyRoomsLobbyIdViewCharacterImport.update({
    id: '/lobby-rooms/$lobbyId/view-character',
    path: '/lobby-rooms/$lobbyId/view-character',
    getParentRoute: () => AuthonlyRoute,
} as any);

const AuthonlyLobbyRoomsLobbyIdCreateCombatRoute = AuthonlyLobbyRoomsLobbyIdCreateCombatImport.update({
    id: '/lobby-rooms/$lobbyId/create-combat',
    path: '/lobby-rooms/$lobbyId/create-combat',
    getParentRoute: () => AuthonlyRoute,
} as any);

const AuthonlyLobbyRoomsLobbyIdCreateCharacterRoute = AuthonlyLobbyRoomsLobbyIdCreateCharacterImport.update({
    id: '/lobby-rooms/$lobbyId/create-character',
    path: '/lobby-rooms/$lobbyId/create-character',
    getParentRoute: () => AuthonlyRoute,
} as any);

const AuthonlyLobbyRoomsLobbyIdGameRoomsGameIdRoute = AuthonlyLobbyRoomsLobbyIdGameRoomsGameIdImport.update({
...
const AuthonlyRouteChildren: AuthonlyRouteChildren = {
    ...
    AuthonlyLobbyRoomsLobbyIdCreateCharacterRoute: AuthonlyLobbyRoomsLobbyIdCreateCharacterRoute,
    AuthonlyLobbyRoomsLobbyIdCreateCombatRoute: AuthonlyLobbyRoomsLobbyIdCreateCombatRoute,
    AuthonlyLobbyRoomsLobbyIdViewCharacterRoute: AuthonlyLobbyRoomsLobbyIdViewCharacterRoute,
    AuthonlyLobbyRoomsLobbyIdIndexRoute: AuthonlyLobbyRoomsLobbyIdIndexRoute,
    AuthonlyLobbyRoomsLobbyIdGameRoomsGameIdRoute: AuthonlyLobbyRoomsLobbyIdGameRoomsGameIdRoute,
};

const AuthonlyRouteWithChildren = AuthonlyRoute._addFileChildren(AuthonlyRouteChildren);
