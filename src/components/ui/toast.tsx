    ...
    <ToastPrimitives.Viewport
        ...
        className={cn(
            ...
            props.variant && props.variant === 'bottom-left'
                ...
                : 'sm:left-1/2 sm:top-0 sm:-translate-x-1/2 sm:transform',
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <ToastPrimitives.Action
        ref={ref}
        className={cn(
            `text-sm inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 font-medium ring-offset-background transition-colors hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 group-[.destructive]:border-muted/40 group-[.destructive]:hover:border-destructive/30 group-[.destructive]:hover:bg-destructive group-[.destructive]:hover:text-destructive-foreground group-[.destructive]:focus:ring-destructive`,
            className
        )}
        {...props}
    />
